...
class Track:
    ...
    def addNote(self, measure, startBeat, noteName="A4", noteType = "sine", amp = 1.0, beats = 1.0, filterType = None, cutoffType = None, filename="defaultFilename"):
        if noteName != 'O':
            totalLength = 0
...
# initialize 5 tracks
track1 = Track(timeSig=userTimeSig)
track2 = Track(timeSig=userTimeSig)
track3 = Track(timeSig=userTimeSig)
track4 = Track(timeSig=userTimeSig)
track5 = Track(timeSig=userTimeSig)
track6 = Track(timeSig=userTimeSig)
...
if METROID == 1:
    ...
    track2.addNote(0, 0, "E5", "trumpet", 0.5, 5.0, None, None)
    ...
    track2.addNote(1, 0, "C5", "trumpet", 0.5, 5.0, None, None)
    ...
    track2.addNote(2, 0, "A4", "trumpet", 0.5, 5.0, None, None)


    track1.addNote(3, 0, "C5", "sine", 1.0, 3.0, None, None)
    track1.addNote(3, 1, "B4", "sine", 1.0, 3.0, None, None)

    track2.addNote(3, 0, "E4", "trumpet", 0.5, 3.0, None, None)
    track2.addNote(3, 0, "G4", "trumpet", 0.5, 3.0, None, None)
    ...
    track2.addNote(4, 0, "E5", "trumpet", 0.5, 5.0, None, None)
    ...
    track2.addNote(5, 0, "C5", "trumpet", 1.0, 5.0, None, None)
    ...
    track2.addNote(6, 0, "F4", "trumpet", 0.5, 4.0, None, None)


    track1.addNote(7, 0, "C6", "sine", 1.0, 3.0, None, None)
    track1.addNote(7, 1, "B5", "sine", 1.0, 3.0, None, None)

    track2.addNote(7, 0, "G5", "trumpet", 0.5, 6.0, None, None)
